          ...
          <div className="flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500">
            <div className="flex flex-col">
              ...
              <input
                ...
                className="w-full rounded border border-gray-300 cpx-3 py-2 mt-1.5 outline-none"
                required
            ...
            <div className="flex flex-col">
              ...
              <input
                ...
                className="w-full rounded border border-gray-300cpx-3 py-2 mt-1.5 outline-none"
                required
