...
const Dashboard = () => {
  ...
  return (
    <div>
      <Title title='Dashboard' subTitle='Monitor your room listings , track bookings and analyze revenue-all in one place. Stay 
      updated with real-time insights to ensure smooth operations.' align='left'  font='outfit'/>
